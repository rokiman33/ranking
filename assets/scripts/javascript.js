window.onload = function() { 
    animateprogress("#mint",91);
    animateprogress("#Ubuntu",85);
    animateprogress("#Kubuntu",80);
    animateprogress("#CentOS",75);
    animateprogress("#SUsE",70);
    animateprogress("#RedHat",65);
    animateprogress("#Gentoo",60);
    animateprogress("#Mandriva",55);
    animateprogress("#Slackware",50);
    animateprogress("#Android",45);
    animateprogress("#ArchLinux",40);
    animateprogress("#Manjaro",35);
    animateprogress("#Debian",30);
    animateprogress("#Fedora",25);
    animateprogress("#Knoppix",23);    
}
